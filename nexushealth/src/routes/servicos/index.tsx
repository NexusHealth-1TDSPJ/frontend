...
export default function Servicos() {
  ...
  return (
    <main className="fundo-pagina">
      <h1 className="titulo-principal">Serviços</h1>

      <section className="secao-servicos">
        <h2 className="subtitulo-servicos">Serviços oferecidos pelo HCFMUSP</h2>

        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto Central (ICHC)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto do Coração (InCor)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto da Criança e do Adolescente (ICr)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto do Tratamento do Câncer Infantil (ITACI)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto de Medicina Física e Reabilitação (IMREA)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto de Ortopedia e Traumatologia (IOT)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto de Psiquiatria (IPq)</h3>
          <p className="texto-instituto">
        ...
        <div className="bloco-instituto">
          <h3 className="titulo-instituto">Instituto de Radiologia (InRad)</h3>
          <p className="texto-instituto">
